 ...
 * Ugliness  *
 *************/
auth_function_t main_function_list[5][96] = {
	{
		{ 0, 0x0, 0x0 },
		{ 0, 0x0, 0x0 },
		{ 0, 0x0, 0x0 },
...
struct buffer_t type_three_list[NUM_TYPE_THREES]={
...
struct buffer_t type_four_list[NUM_TYPE_FOURS]={
...
struct buffer_t type_five_list[NUM_TYPE_FIVES]={

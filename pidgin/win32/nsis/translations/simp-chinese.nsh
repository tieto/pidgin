...
!define PIDGIN_IS_RUNNING			"Gaim 的实例正在运行中。请退出 Gaim 然后再试一次。"
...
; Components Page
!define PIDGIN_SECTION_TITLE			"Gaim 即时通讯程序(必需)"
...
!define PIDGIN_SECTION_DESCRIPTION		"Gaim 核心文件和 DLLs"
...
!define PIDGIN_SHORTCUTS_SECTION_DESCRIPTION   "启动 Gaim 的快捷方式"
!define PIDGIN_DESKTOP_SHORTCUT_DESC   "在桌面上创建 Gaim 的快捷方式"
!define PIDGIN_STARTMENU_SHORTCUT_DESC   "在开始菜单中创建 Gaim 的快捷方式"

; GTK+ Directory Page
!define GTK_UPGRADE_PROMPT			"发现了旧版本的 GTK+ 运行时刻。您想要升级吗?$\r注意: 除非您进行升级，否则 Gaim 可能无法工作。"

; Finish Page
!define PIDGIN_FINISH_VISIT_WEB_SITE		"浏览 Windows Gaim 网页"

; Gaim Section Prompts and Texts
!define PIDGIN_UNINSTALL_DESC			"Gaim (只能删除)"
...
!define un.PIDGIN_UNINSTALL_ERROR_1         "卸载程序找不到 Gaim 的注册表项目。$\r可能是另外的用户安装了此程序。"

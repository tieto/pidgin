...
!define PIDGIN_IS_RUNNING				"Gaim 正在執行中，請先結束這個程式後再行安裝。"
...
; Components Page
!define PIDGIN_SECTION_TITLE			"Gaim 主程式 (必需)"
...
!define PIDGIN_SECTION_DESCRIPTION		"Gaim 核心檔案及動態函式庫"
...
!define PIDGIN_SHORTCUTS_SECTION_DESCRIPTION	"建立 Gaim 捷徑"
...
!define PIDGIN_FINISH_VISIT_WEB_SITE		"拜訪 Windows Gaim 網頁"

; Gaim Section Prompts and Texts
!define PIDGIN_UNINSTALL_DESC			"Gaim v${PIDGIN_VERSION} (只供移除)"
...
!define un.PIDGIN_UNINSTALL_ERROR_1		"移除程式無法找到 Gaim 的安裝資訊。$\r這應該是有其他的使用者重新安裝了這個程式。"
!define un.PIDGIN_UNINSTALL_ERROR_2		"您目前的權限無法移除 Gaim。"

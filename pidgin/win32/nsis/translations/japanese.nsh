...
!define PIDGIN_IS_RUNNING				"Gaim が実行されています。Gaim を終了してから再度実行してください"
...
; Components Page
!define PIDGIN_SECTION_TITLE			"Gaimインスタントメッセンジャ (必須)"
...
!define PIDGIN_SECTION_DESCRIPTION		"Gaimの核となるファイルとdll"
...
!define PIDGIN_SHORTCUTS_SECTION_DESCRIPTION	"Gaim を実行するためのショートカット"
!define PIDGIN_DESKTOP_SHORTCUT_DESC		"デスクトップに Gaim のショートカットを作成する"
!define PIDGIN_STARTMENU_SHORTCUT_DESC		"スタートメニューに Gaim の項目を作成する"

; GTK+ Directory Page
!define GTK_UPGRADE_PROMPT			"古いバージョンのGTK+ランタイムが見つかりました。アップグレードしますか?$\r注意: Gaimはアップグレードしない限り動かないでしょう。"

; Installer Finish Page
!define PIDGIN_FINISH_VISIT_WEB_SITE		"Windows GaimのWebページを訪れてください。"

; Gaim Section Prompts and Texts
!define PIDGIN_UNINSTALL_DESC			"Gaim (削除のみ)"
...
!define un.PIDGIN_UNINSTALL_ERROR_1		"アンインストーラはGaimのレジストリエントリを発見できませんでした。$\rおそらく別のユーザにインストールされたでしょう。"

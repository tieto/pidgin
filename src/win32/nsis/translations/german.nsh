...
LangString GTK_THEMES_SECTION_DESCRIPTION		${LANG_GERMAN} "GTK+ Themen können Aussehen und Bedienung von GTK+ Anwendungen verändern."
...
LangString GTK_PAGE_INSTALL_MSG2			${LANG_GERMAN} "Um in einen anderen Ordner zu installieren, klicken Sie auf Durchsuchen und wählen Sie einen anderen Ordner. Klicken Sie Weiter zum Fortfahren."
...
LangString GAIM_PROMPT_WIPEOUT			${LANG_GERMAN} "Ihre altes Gaim-Verzeichnis soll gelöscht werden. Möchten Sie fortfahren?$\r$\rHinweis: Alle nicht-Standard Plugins, die Sie evtl. installiert haben werden$\rgelöscht. Gaim-Benutzereinstellungen sind nicht betroffen."

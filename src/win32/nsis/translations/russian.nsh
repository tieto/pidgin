...
!define GAIM_PROMPT_WIPEOUT			"Ваша старая директория Gaim будет фактически удалена. Вы желаете продолжить ?$\r$\rПримечание: Все нестандартные плагины которые Вы установили будут удалены..$\rПользовательские настройки Gaim не пострадают."

...
!define GAIM_PROMPT_WIPEOUT			"Váš adresár Gaim bude zmazaný. Chcete pokračovať?$\r$\rPoznámka: Všetky prídavne pluginy, ktoré ste nainštalovali budú tiež zmazané.$\rNastavenia uživateľského účtu Gaim-u budú ponechané."
!define GAIM_PROMPT_DIR_EXISTS			"Adresár, ktorý ste zadali, už existuje. Jeho obsah bude zmazaný. Chcete pokračovať?"

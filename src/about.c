...
void show_about(GtkWidget *w, void *data)
{
	...
	str = g_strconcat(
			...
			"  <b>", _("Japanese"), "(ja)</b> - Takashi Aihana &lt;<a href=\"aihana@gnome.gr.jp\">aihana@gnome.gr.jp</a>&gt;<br>"
			"  <b>", _("Lithuanian"), "(lt)</b> - Gediminas �~Li�~Minskas &lt;<a href=\"gediminas@parok.lt\">gediminas@parok.lt</a>&gt;<br>"

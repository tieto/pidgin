...
# into ~/pidgin-2.1.1/libpurple/protocols at the correct location.
...
mv ~/pidgin-2.1.1/config.h ~/pidgin-2.1.1/config.h-
make -f Makefile.mingw
mv ~/pidgin-2.1.1/config.h- ~/pidgin-2.1.1/config.h
cp ~/pidgin-2.1.1/win32-install-dir/plugins/libmyspace.dll .
...
cp ~/pidgin-2.1.1/win32-install-dir/pixmaps/pidgin/protocols/48/myspace.png \
                win32-archive/pixmaps/pidgin/protocols/48/
cp ~/pidgin-2.1.1/win32-install-dir/pixmaps/pidgin/protocols/22/myspace.png \
                win32-archive/pixmaps/pidgin/protocols/22/
cp ~/pidgin-2.1.1/win32-install-dir/pixmaps/pidgin/protocols/16/myspace.png \
                win32-archive/pixmaps/pidgin/protocols/16/
mkdir -p win32-archive/pixmaps/pidgin/emotes/default
cp ~/pidgin-2.1.1/win32-install-dir/pixmaps/pidgin/emotes/default/theme \
        win32-archive/pixmaps/pidgin/emotes/default/theme
# Emoticons in MySpaceIM but not Pidgin 2.1.0
cp ~/pidgin-2.1.1/win32-install-dir/pixmaps/pidgin/emotes/default/{sinister,sidefrown,pirate,mohawk,messed,bulgy-eyes}.png \

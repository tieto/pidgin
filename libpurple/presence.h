...
#define PURPLE_TYPE_CONVERSATION_PRESENCE             (purple_conversation_presence_get_type())
#define PURPLE_CONVERSATION_PRESENCE(obj)             (G_TYPE_CHECK_INSTANCE_CAST((obj), PURPLE_TYPE_CONVERSATION_PRESENCE, PurpleConversationPresence))
#define PURPLE_CONVERSATION_PRESENCE_CLASS(klass)     (G_TYPE_CHECK_CLASS_CAST((klass), PURPLE_TYPE_CONVERSATION_PRESENCE, PurpleConversationPresenceClass))
#define PURPLE_IS_CONVERSATION_PRESENCE(obj)          (G_TYPE_CHECK_INSTANCE_TYPE((obj), PURPLE_TYPE_CONVERSATION_PRESENCE))
#define PURPLE_IS_CONVERSATION_PRESENCE_CLASS(klass)  (G_TYPE_CHECK_CLASS_TYPE((klass), PURPLE_TYPE_CONVERSATION_PRESENCE))
#define PURPLE_CONVERSATION_PRESENCE_GET_CLASS(obj)   (G_TYPE_INSTANCE_GET_CLASS((obj), PURPLE_TYPE_CONVERSATION_PRESENCE, PurpleConversationPresenceClass))
 ...
 *
 * @note When a presence is destroyed with g_object_unref(), all statuses added
 *       to that will also be destroyed along with the presence.
 */
...
/**
 * Status information for a conversation.
 */
...
/**
 * Status information about a buddy.
 */
...
/**
 * Creates a presence for a conversation. TODO rename
 *
...
/**
 * Returns the GType for the PurpleConversationPresence object.
 */
GType purple_conversation_presence_get_type(void);
